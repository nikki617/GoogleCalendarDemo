...
from streamlit_community.chat_message_histories import StreamlitChatMessageHistory
from streamlit_community.callbacks.streamlit import StreamlitCallbackHandler
from langchain.callbacks.tracers import ConsoleCallbackHandler

# Import functions from other files
from calendar_integration import get_calendar
from llm_integration import create_tools, create_llm_agent

# Initialize the calendar
calendar = get_calendar()

# Create LangChain tools and agent
tools = create_tools(calendar)
